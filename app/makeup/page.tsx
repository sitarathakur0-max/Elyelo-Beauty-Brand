...
export default async function MakeupPage() {
  const products = await getProductsByCategory('makeup')
      ...
      <section className="relative bg-soft-neutral py-16 md:py-20 border-b border-border overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div 
            ...
            style={{ backgroundImage: "url('/images/categories/makeup-hero.jpg')" }}
          />
        </div>
        <div className="container-custom relative z-10 text-center max-w-2xl mx-auto">
          ...
          <p className="text-gray-600 text-sm md:text-base">
            Beauty essentials to enhance your everyday look — 
            from high-coverage foundations to long-lasting lip colors and mascara.
          </p>
      ...
      <section className="container-custom py-12">
        {products.length === 0 ? (
          <div className="text-center py-12 bg-soft-neutral rounded-lg">
            <p className="text-gray-500">No makeup products available.</p>
          </div>
        ) : (
